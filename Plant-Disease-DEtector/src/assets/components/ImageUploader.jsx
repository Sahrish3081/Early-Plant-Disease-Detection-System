    ...
    <div className="uploader-section">
      {!imagePreview ? (
        ...
        >
          ...
          <input ref={inputRef} type="file" accept=".jpg,.jpeg,.png" hidden
        ...
        <div className="preview-container">
          <div className="preview-img-wrap">
            ...
            <button className="preview-remove" onClick={() => onImageSelected(null, null)}>✕</button>
          </div>
          <div className="file-meta">
            <span className="file-icon">🖼️</span>
            <div>
              <p className="file-name">{imageFile?.name}</p>
              <p className="file-size">{imageFile ? (imageFile.size / 1024).toFixed(1) + " KB" : ""}</p>
            </div>
          </div>
