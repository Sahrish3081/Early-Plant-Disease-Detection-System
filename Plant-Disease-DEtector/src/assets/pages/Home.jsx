import LeafBg from "../components/LeafBg";
    ...
    <section className="hero">
      <div className="hero-content">
        ...
        <p className="hero-sub">
          Upload a photo of your plant and get an instant AI diagnosis with
          annotated disease spots, severity analysis, and expert treatment recommendations.
        </p>
        <div className="hero-actions">
          <button className="cta-btn" onClick={() => setPage("Detect")}>🔍 Start Detection</button>
          <button className="cta-btn-outline" onClick={() => setPage("About")}>Learn More</button>
        </div>
      </div>
        ...
        <div className="hero-card-float">
          <svg viewBox="0 0 200 200" className="scan-svg">
            ...
            <rect x="10" y="10" width="180" height="180" rx="12"
              fill="none" stroke="#52b788" strokeWidth="2" strokeDasharray="20 10">
              <animateTransform attributeName="transform" type="rotate"
                from="0 100 100" to="360 100 100" dur="8s" repeatCount="indefinite"/>
            </rect>
            <line x1="10" x2="190" stroke="#52b788" strokeWidth="1.5" opacity="0.7">
